...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        # 生成自我肯定语并保存结果到CSV文件
        # output_file = "./output/自我肯定语结果单条.csv"
        # checkpoint_file = "./output/checkpoint_single.txt"
        # generate_self_affirmative_phrase(role_prompt, symptoms_data, output_file, checkpoint_file, n=5)    
    else:
